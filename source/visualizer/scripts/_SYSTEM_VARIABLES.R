...
if(IS_BASE_SURVEY=="Yes"){
  ...
  #   Non-Survey Base
  BASELINE_SCENARIO_ALT <- BASELINE_SCENARIO_NAME
  DISTRICT_FLOW_CENSUS  <- BASELINE_SCENARIO_NAME
  AO_CENSUS_SHORT       <- BASELINE_SCENARIO_NAME
  AO_CENSUS_LONG        <- BASELINE_SCENARIO_NAME
  WFH_Source            <- BASELINE_SCENARIO_NAME
}
...
stopPurposes          <- c("Work","Univ","Schl","Esco","Shop","Main","Eati","Visi","Disc")
...
tourMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike','Walk-Transit','PNR-Transit', 'KNR-Transit', 'School Bus', 'Ride Hail')
tripMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike','Walk-Transit','PNR-Transit', 'KNR-Transit', 'School Bus', 'Ride Hail')
...
timePeriods           <- c("NT1","AM","MD","PM","NT2")
timePeriodBreaks      <- c(1,7,13,25,33,49)
...
# For fixing county flow headings
heading_factors = factor(c("DC", "Alexandria", "Anne Arundel", "Arlington", "Calvert", "Carroll", "Charles", "Clarke", "Fairfax", "Fauquier", "Frederick",
                           "Fredericksburg", "Howard", "Jefferson", "King George", "Loudoun", "Montgomery", "Prince George's", "Prince William",
                           "Spotsylvania", "St. Mary's", "Stafford", "Total"), ordered = T)

col_factors = c("X", "DC", "Alexandria", "Anne Arundel", "Arlington", "Calvert", "Carroll", "Charles", "Clarke", "Fairfax", "Fauquier", "Frederick",
                       "Fredericksburg", "Howard", "Jefferson", "King George", "Loudoun", "Montgomery", "Prince George's", "Prince William",
                       "Spotsylvania", "St. Mary's", "Stafford", "Total")

colname_translator = c("X" = "X", "Alexandria" = "Alexandria",  "Anne.Arundel" = "Anne Arundel",  "Arlington" = "Arlington",  "Calvert" = "Calvert",
                       "Carroll" = "Carroll", "Charles" = "Charles", "Clarke" =  "Clarke", "DC" = "DC", "Fairfax" = "Fairfax", "Fauquier" = "Fauquier",
                       "Frederick" = "Frederick", "Fredericksburg" = "Fredericksburg", "Howard" = "Howard", "Jefferson" = "Jefferson",
                       "King.George" = "King George", "Loudoun" = "Loudoun", "Montgomery" = "Montgomery", "Prince.George.s" = "Prince George's",
                       "Prince.William" = "Prince William", "Spotsylvania" = "Spotsylvania", "St..Mary.s" =  "St. Mary's", "Stafford" = "Stafford",
                       "Total" = "Total")
